...
<div class="slider-area">
	<div class="container">
		<div class="row">
			<ul class="nav nav-tabs" style="margin-left: 14px;border-bottom:0px solid #ffffff;">
				<li class="active"><a class="tab-change" data-toggle="tab" data-value="1"  href="#home" style="background-color: #dcdcdc; 
						...
						while ($row = mysqli_fetch_array($resultb)) {
							...
							<div class="single-product  white-bg col-md-12 col-sm-12 col-xs-12" style="max-height: 195px;">
								...
								<div class="row" style="height: 250px;">
									<div class="col-md-3 col-sm-4 col-xs-6" style="border-right: 1px solid #f5f5f5;">
										<div class="product-img pt-20 center" style="padding-bottom:25px; padding-top: 17px; height: 175px; overflow: hidden;">
									...
									<div class="col-md-6 col-sm-6 col-xs-6" style="border-right: 1px solid #f5f5f5;">
										<div class="" style="padding: 40px 0px 0px 0px;">
											<div class="pro-title">
										...
										<div style="margin-top:40px;">
											<div class="f-left pntr">
												...
												<?php if (isset($_SESSION['user'])) { ?>
													...
													<a class="button btn-primary" style="padding:5px; <?php echo $display;?>"><span class="add-to-acc" data-id-product="<?php echo $row['itemcode'];?>"><i class="fa fa-shopping-cart"></i> Add to Cart</span></a>
												...
												<?php } else { ?>
													...
													<a class="button btn-primary" style="padding:5px; <?php echo $display;?>"><span class="add-to-acc-temp" data-id-product="<?php echo $row['itemcode'];?>"><i class="fa fa-shopping-cart"></i> Add to Cart</span></a>
    ...
    <div id="home" class="tab-pane fade in active">
    	<div class="row">
    		...
    		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  id="page-content1">
    			...
    			while ($row = mysqli_fetch_array($resultb2)) {
    				...
    				<div class="single-product  white-bg col-md-3 col-sm-12 col-xs-6">
    					<div class="product-img pt-20 center" style="height: 175px; overflow: hidden;">
    						<a <?php if(($row['eq_code']!='') && ($row['qty'] == 0)){?>href="details-equility-products.php?key=4&id=<?php echo $row['eq_code']; ?>" <?php }else{?> href="details-products-sumedacellular-kurunegala?subc=<?php echo $row['sccode'];?>&icode=<?php echo $row['itemcode'];?>" <?php }?>><img src="images/sumeda_p/<?php  echo $row['imgpath'];?>" alt="<?php echo $row['book']; ?>" style="width:180px; min-height: 150px;"/></a>
    					</div>
    					...
    					<div class="product-content " style="margin-bottom: 10px;">
    						...
    						<?php
								...
								?>
							<h5 style=" color: <?php echo $color; ?>; margin-top: 10px;"><?php echo $stk; ?></h5>
							<a href="contact-us-sumedacellular-kurunegala-srilanka?inquiry=1&id=<?php echo $row['itemcode'];?>" class="button btn-primary hidden-xs" style="padding:5px;"><span><i class="fa fa-phone"></i> CONTACT US</span></a>
							<?php 
								}if(($qty == 0) && ($row['eq_code']!='')){
									$stk = "Switch to equal";
									$color  =  "white";
							...
							?>
							<h5 style=" color: <?php echo $color; ?>; margin-top: 10px;"><?php echo $stk; ?></h5>
							<a href="details-equility-products.php?key=4&id=<?php echo $row['eq_code']; ?>" class="button btn-primary hidden-xs" style="padding:5px;"><span><i class="fa fa-reply"></i> SIMILAR PRODUCT</span></a>
							<?php 
								}else if($qty != 0){
									$stk = "Stock Available";
									$color  =  "green";
...
<script type="text/javascript">
	...
	function add_to_acc(id) {
		...
		$(".wish_item").click(function () {
			...
			var uid = $('#uid').val();
			// $('#wish_'+item_id).toggleClass('fa-heart-o fa-heart');
			$.post('connection/cart_conn.php', {add_to_wishlist: 'data', item_id:item_id, uid:uid}, function (data) {
				if (data.msgType === 1) {
					$('#wish_'+item_id).toggleClass('fa-heart-o fa-heart');
					$('#wish2_'+item_id).toggleClass('fa-heart-o fa-heart');
					// $('#wish2_'+item_id).hide();
					...
					alert("Item Already Exists in Wish List");
					// $('#wish_'+item_id).removeClass('fa-heart');		
					// $('#wish_'+item_id).addClass('fa-heart-o ');		
				}
			}, "json");
		});
