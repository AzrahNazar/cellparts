	...
	<div class="col-xl-3"></div>
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Change admin details</h3>
              <!-- tools box -->
              
              <!-- /. tools -->
            </div>
            <div class="box-body">
              <form action="func/pwd_fun.php?id=<?php echo $val; ?>" method="post">
                <div class="form-group row">
				  <label for="example-text-input" class="col-sm-2 col-form-label">Username</label>
				  <div class="col-sm-10">
					<input class="form-control" type="text" value="<?php echo $user ?>" id="example-text-input" name="uname">
				  </div>
				</div>
               <div class="form-group row">
				  <label for="example-text-input" class="col-sm-2 col-form-label">Password</label>
				  <div class="col-sm-10">
					<input class="form-control" type="password" id="example-text-input" name="pwd">
				  </div>
				</div>
            <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-blue" id="sendEmail"> Change</button>
            </div>
