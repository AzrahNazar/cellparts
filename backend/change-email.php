  ...
  <div class="content-wrapper">
	...
	<div class="col-xl-3"></div>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <form action="func/editmail.php?id=<?php echo $id; ?>" method="post">
                <div class="form-group row">
				  <label for="example-text-input" class="col-sm-2 col-form-label">E-mail</label>
				  <div class="col-sm-10">
					<input class="form-control" type="text" value="<?php echo $mail; ?>" id="example-text-input" name="email">
				  </div>
				</div>
             
                <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-blue">Update</button>
            </div>
