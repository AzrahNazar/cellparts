	...
	<div class="row">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <form action="func/addbanner_fun.php" method="post" enctype="multipart/form-data">

          		 <div class="form-group">

                  <label for="example-text-input">Product link</label>

                  <textarea class="form-control" rows="3" id="link" name="link" required></textarea>
         ...
         <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
				...
				<?php $sql = mysqli_query($conn,"SELECT * FROM banner ORDER BY b_id DESC");
					...
					<tr>
						...
						<img src="../img/slider/<?php  echo $row['img']; ?>" width="150px" class="img-thumbnail"></td>

						<td><?php  echo $row['link']; ?> </td>

							<td><a href="edit-banner.php?id=<?php echo $row['b_id']; ?>"><i class="fa fa-pencil"></i> EDIT </a></td>

						<td><a href="func/removebanner_fun.php?id=<?php  echo $row['b_id']; ?>" onclick="return confirm('Are you sure you want to delete this?');"><i class="fa fa-trash"></i> DELETE </a></td>
