  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Mini banner top</a></li>
	...
	<div class="row">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Change icon </h3>
              <!-- tools box -->
              
              <!-- /. tools -->
            </div>
            <div class="box-body">
              <form action="func/cat_icon_fun.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                
               <?php $sql = mysqli_query($conn,"SELECT * FROM cat WHERE ccode='$id'");
								$x = 0;
...
<span>Size: 42*42</span><br> <span class="pull-right">Image type : png </span><br>

                  <img src="../img/menu-l/<?php echo $row['img']; ?>" style="width:50px;height:50px;background:#ffffff;" />
