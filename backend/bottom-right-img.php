  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Bottom right image</a></li>
	...
	<div class="row">
          ...
          <div class="box box-info">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">Add bottom right image </h3>
            ...
            <div class="box-body">
              ...
              <form action="func/img_bottom_right_fun.php" method="post" enctype="multipart/form-data">
         ...
         <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
				...
				$sql = mysqli_query($conn,"SELECT * FROM bottom_right_img ORDER BY id DESC");
					...
					<tr>
						...
						<td><a href="func/bottom-img-remove-fun.php?id=<?php  echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this?');"><i class="fa fa-trash"></i> DELETE </a></td>
