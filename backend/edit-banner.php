...
$sql="SELECT * FROM banner WHERE b_id='$bid' ";
  ...
  <div class="content-wrapper">
	...
	<div class="row">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <form action="func/edit-main-banner-fun.php?id=<?php echo $bid; ?>" method="post" enctype="multipart/form-data">
			  
          		 <div class="form-group">
                  <label for="example-text-input">Product link</label>
                  <textarea class="form-control" rows="3" id="link" name="link" required><?php echo $link; ?></textarea>
				 ...
				 <div class="form-group">
				  ...
				  <img src="../img/slider/<?php echo $img; ?>" width="250px" class="img-thumbnail"><br><br>
<span style="color:red;">Size: 600*400</span>
                 
                </div>
				 <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-blue" id="sendEmail"> Edit</button>
            </div>
              </form>
            </div>
