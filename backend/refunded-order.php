...
$sql="SELECT User_ID,order_id,status FROM cart_details  group by User_ID,order_id,status having status ='Delivered'";
        ...
        <div class="col-12">
         ...
         <div class="box">
            <div class="box-header">
              <h3 class="box-title">Refunded Orders</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-responsive">
				...
				<tbody>
					...
					$sqln="SELECT *, DATE_FORMAT(order_date, '%Y-%m-%d') AS odate FROM order_details WHERE status='Refunded' ORDER BY odate DESC";
...
?>
					...
					<tr>
						...
						<td>
				<a href="view-order.php?id=<?php  echo $row3['inv_id']; ?>" class="btn btn-lg btn-success btn-block margin-top-10" width="45">
