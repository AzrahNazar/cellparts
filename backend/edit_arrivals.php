  ...
  <div class="content-wrapper">
	...
	<div class="row">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <form action="func/edit_arrivals_fun.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group row">
				 ...
				 <div class="form-group">
                  ...
                  <input type="file" id="exampleInputFile" name="file">
				   <img src="../images/new_p/<?php echo $img; ?>" width="250px" class="img-thumbnail">
<br>
