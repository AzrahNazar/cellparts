							...
							<div class="box-body">
								...
								<form action="func/bank_fun.php" method="post">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input class="form-control" type="text" value="" id="example-text-input" name="bank" autocomplete="off">
										</div>
									</div>

									<div class="box-footer clearfix">

										<button type="submit" class="pull-right btn btn-blue">Add Bank</button>
						...
						<div class="box">
							...
							<div class="box-body">
								<table id="example1" class="table table-bordered table-striped table-responsive">
									...
									<tbody>
										<?php $sql = mysqli_query($conn, "SELECT * FROM bank");
										$x = 0;
										while($row = mysqli_fetch_array($sql)) {
											...
											<tr>
												<td><?php echo $row['bank']; ?></td>
													...
													<td><a class=" btn  btn-danger" href="func/bank_fun.php?id=<?php  echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this?');"><i class="fa fa-trash"></i> DELETE </a></td>
												</tr>
											<?php } ?>
										</tbody>
									</table>
