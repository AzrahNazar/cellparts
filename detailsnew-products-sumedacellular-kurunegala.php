...
<?php include "common/mobilemenu.php"; ?>
		...
		<div class="slider-area">
			<div class="container">
				...
				$sql="SELECT * FROM home_forth where bid='$id'";
    ...
    margin-left: 2px;">
							...
							<img src="images/new_p/<?php echo $shrow['img'];?>" style="padding-top:30px;width:250px;height:250px;" id="myImg" alt="<?php echo $shrow['name'];?>">
							<input id="pid" type="hidden" class="form-control" value="<?php echo $shrow['bid'];?>" style="width:250px">
							<input type="hidden" id="flag" class="form-control" value="1">
				...
				<?php } ?>
						...
						<!--<div class="slider-product dotted-style-1 pt-30" style="margin-top:5px;padding-top: 10px;">
							<button class="btn btn-success"><span>Confirm </span></button>
							<a href="#">
		...
		<!-- social_block-end -->
	                ...
	                //$(".ajax_cart_quantity").text(data);
                                                    ...
                                                    function add_to_cart(id) {
                                                        ...
                                                        $.post('connection/index.php', {'add_to_cart': 'data', id: id, uid: uid, qty:qty, pid:pid, flag:flag}, function (data) {
                                                        ...
                                                        $.post('connection/index.php', {'add_to_cart_temp': 'data', id: id, qty:qty, pid:pid, flag:flag}, function (data) {
