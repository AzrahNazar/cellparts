...
<header>
	...
	<link rel="stylesheet" href="treeview/dist/x-tree-select.css">

	<script src="https://code.jquery.com/jquery-2.2.4.min.js"></script>
	<script src="treeview/src/x-tree-select.js"></script>
	<link rel="stylesheet" href="treeview/src/x-tree-select.css">
	<link rel="stylesheet" href="demo/assets/prism.css">

	<script src="demo/assets/prism.js"></script>
	...
	<script type="text/javascript">
									...
									<div class="col-lg-7 col-md-7 col-sm-8 hidden-xs">
										<div class="header-top-right">
											...
											<?php if(!isset($_SESSION['user'])) { ?>
												<ul>
													<li class="slide-toggle"><a href="register"><i class="fa fa-user-plus"></i> Register Now</a>
													</li>
												</ul>
												<ul>
							...
							<div class="header-bottom-middle">
								...
								<div class="search-box">
									<form method="post" action="search.php">
										<div class="row">
											<div class="col-md-5">
												<input type="text" id="demo5" placeholder="Please choose an item"/>
											</div>
											<div class="col-md-7">
        ...
        <!-- <script src="treeview/path/to/jquery.min.js"></script> -->
        
        <script src="treeview/dist/x-tree-select"></script>
		...
		{ 	
			...
			<?php
				...
				while ($row3 = mysqli_fetch_array($coresult3)){ ?>
					...
					{
						t: '<?php echo $row3['subcat'];?>',
						v: <?php echo $row3['sccode'];?>,
						c: []
					},
			<?php }  ?>
			]
