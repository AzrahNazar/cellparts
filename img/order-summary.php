							...
							<div class="slider-container">
								...
								<!-- <form method="post" action="https://www.payhere.lk/pay/checkout" id="form_sandbox" style="display: none;"> -->
									<form method="post" action="https://sandbox.payhere.lk/pay/checkout" id="form_sandbox" style="display:none">  <!--SandBox URL  --> 
										...
										<input type="text" name="return_url" value="https://www.test.cellparts.lk/order-confirm" readonly>
										<input type="text" name="cancel_url" value="https://www.test.cellparts.lk/order-cancel" readonly>
										<input type="text" name="notify_url" value="https://www.test.cellparts.lk/connection/payment_verify" readonly>
  	...
  	$("#btn_order").click(function() {
  		...
  		if (tot_amnt > 0) {
  			...
  			if(chk) {
  				...
  				$.post('connection/payment_confirm.php', {'up_payment_method': 'data', inv: inv, pay_type: '1', del_type: del_type, del_fee:del_fee, packaging:packaging}, function (data) {
  	...
  	$("#btn_order_bank").click(function() {
  		...
  		if (tot_amnt > 0) {
  			...
  			if(chk) {
  				...
  				$.post('connection/payment_confirm.php', {'payment_confirm': 'data', del_type: del_type, packaging:packaging, del_fee:del_fee}, function (data) {
  					if (data.status === 'success') {
  						var inv = data.inv_id;
