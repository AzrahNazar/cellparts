			...
			<div class="container">
              ...
              <form id="login-form" method="post">
                ...
                <div class="form-group">
                  <label>Enter your activation code:<span class="required">*</span></label>
                  <input type="text" class="form-control" name="acc_code" id="acc_code" autocomplete="off" required>
                </div>
				...
				<div class="row"> 
					...
					<div class="col-md-4">
						<a type="submit" class="btn btn-primary btn-inline" id="btn_acc_verify">Activate</a>
					</div>
					<div class="col-md-4"></div>
