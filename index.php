...
<head>
    ...
    <style>
      .single-client a p{border-bottom:1px solid #eee;color:#666;display:block;margin:10px 5px 15px;padding:15px;text-align:left}.clint-img{overflow:hidden;padding:0 15px 25px}.client-img-left{float:left;width:40%}.client-name{float:left;width:60%}.client-name span{display:block;margin-left:20px;margin-top:31px}.client-2 .clint-img{width:45%;padding-top:22px;margin-bottom:30px}.product-img{padding-left:18px}.product-content{padding-left:18px}.single-product{margin-right:10px;margin-bottom:10px}.js1:hover .ss{opacity:1;stroke:#fff}.js1:hover .arrow{opacity:1;display:block}.pntr{cursor:pointer}@media (min-width:320px) and (max-width:480px){.container{width:350px}.single-product{margin-right:0;height:280px}}
...
<body>
          ...
          <div class="main-slider">
            <div class="slider-container"> 
              ...
              <script type="text/javascript" defer>
                jssor_1_slider_init=function(){var s={$AutoPlay:1,$SlideshowOptions:{$Class:$JssorSlideshowRunner$,$Transitions:[{$Duration:800,$Opacity:2}],$TransitionsOrder:1},$ArrowNavigatorOptions:{$Class:$JssorArrowNavigator$},$BulletNavigatorOptions:{$Class:$JssorBulletNavigator$}},o=new $JssorSlider$("jssor_1",s),i=980;function r(){var s=o.$Elmt.parentNode.clientWidth;if(s){var t=Math.min(i||s,s);o.$ScaleWidth(t)}else window.setTimeout(r,30)}r(),$Jssor$.$AddEvent(window,"load",r),$Jssor$.$AddEvent(window,"resize",r),$Jssor$.$AddEvent(window,"orientationchange",r)};
              </script>

              <style>
                .jssorl-009-spin img{animation-name:jssorl-009-spin;animation-duration:1.6s;animation-iteration-count:infinite;animation-timing-function:linear}@keyframes jssorl-009-spin{from{transform:rotate(0)}to{transform:rotate(360deg)}}.js1:hover .jssora051{background-color:#000;border-radius:5px}.js1:hover .jssora051:hover{background-color:#fff}.jssorb051 .i{position:absolute;cursor:pointer}.jssorb051 .i .b{fill:#444;fill-opacity:.5}.jssorb051 .i:hover .b{fill-opacity:.7}.jssorb051 .iav .b{fill-opacity:1}.jssorb051 .i.idn{opacity:.3}.jssora051{display:block;position:absolute;cursor:pointer}.jssora051 .a{fill:none;stroke:#fff;stroke-width:1500;stroke-miterlimit:10;opacity:0}.jssora051 svg:hover{fill:none;stroke:#000;stroke-width:1500;stroke-miterlimit:10}.jssora051 .a.ss:hover{stroke:#000}.jssora051.jssora051dn{opacity:.5}.jssora051.jssora051ds{opacity:.3;pointer-events:none}
              </style>
          ...
          <div class="bestseller-area dotted-style-2 hidden-xs" style="">
            ...
            <div class="single-product-items-active border-1">
              <div class="single-product-items">
                <?php	$sql4="SELECT * FROM bookinfo WHERE ccode=54 AND car_access=1 ORDER BY price DESC LIMIT 0,8";
                $result4=mysqli_query($conn,$sql4);
                while ($row4 = mysqli_fetch_array($result4)){ ?>

                   <div class="single-product  white-bg">
                    <div class="product-img pt-20"> <a href="details-products-sumedacellular-kurunegala?subc=<?php echo $row4['sccode'];?>&icode=<?php echo $row4['itemcode'];?>"><img src="images/sumeda_p/<?php  echo $row4['imgpath'];?>" alt="cell phone accessories in kurunegala srilanka" style="height:167px;width:162px;"/></a> </div>
                    <div class="product-content product-i">
                      ...
                      <div class="product-icon">
                        <div class="product-icon-left f-left">
                          <?php if (isset($_SESSION['user'])) { ?>
                            <a class="button"><span class="add-to-acc pntr" data-id-product="<?php echo $row4['itemcode'];?>"><i class="fa fa-shopping-cart"></i> Add to Cart</span></a>
                          <?php } else { ?>
                            <a class="button"><span class="add-to-acc-temp pntr" data-id-product="<?php echo $row4['itemcode'];?>"><i class="fa fa-shopping-cart"></i> Add to Cart</span></a>
                          <?php } ?>
                        </div>
                      </div>
                    </div>
              ...
              <div class="single-product-items">
                <?php $sql4="SELECT * FROM bookinfo WHERE ccode=54 AND car_access=1 ORDER BY price DESC LIMIT 9,15";
                $result4=mysqli_query($conn,$sql4);
                while ($row4 = mysqli_fetch_array($result4)){ ?>
  ...
  <script type="text/javascript">
    function add_to_cart_temp(t){$.post("connection/cart_index.php",{add_to_cart_temp:"data",id:t},function(t){}),setTimeout(function(){cart_data_load_show()},100)}function add_to_cart(t){var a=$("#uid").val();$.post("connection/cart_index.php",{add_to_cart:"data",id:t,uid:a},function(t){}),setTimeout(function(){cart_data_load_show()},100)}function add_to_cart_new(t){var a=$("#uid").val();$.post("connection/cart_index.php",{add_to_cart_new:"data",id:t,uid:a},function(t){}),setTimeout(function(){cart_data_load_show()},100)}function add_to_cart_new_temp(t){$.post("connection/cart_index.php",{add_to_cart_new_temp:"data",id:t},function(t){}),setTimeout(function(){cart_data_load_show()},100)}function add_to_acc(t){var a=$("#uid").val();$.post("connection/cart_index.php",{add_to_acc:"data",id:t,uid:a},function(t){}),setTimeout(function(){cart_data_load_show()},100)}function add_to_acc_temp(t){$.post("connection/cart_index.php",{add_to_acc_temp:"data",id:t},function(t){}),setTimeout(function(){cart_data_load_show()},100)}$(document).ready(function(){$(".pro-add-to-cart").click(function(){add_to_cart($(this).attr("data-id-product")),$(this).replaceWith("<a class='button pro-add-to-cart' title='Added to cart' type='button'><span><i class='fa fa-shopping-cart' style='font-size: 16px;color:#F4A137;'></i> Added to Cart</span></a>")}),$(".pro-add-to-cart-temp").click(function(){$.post("connection/tmp_cart.php",{tmp_cat_add:"data"},function(t){}),add_to_cart_temp($(this).attr("data-id-product")),$(this).replaceWith("<a class='button pro-add-to-cart' title='Added to cart' type='button'><span><i class='fa fa-shopping-cart' style='font-size: 16px;color:#F4A137;'></i> Added to Cart</span></a>")}),$(".add-to-cart-new").click(function(){add_to_cart_new($(this).attr("data-id-product")),$(this).replaceWith("<a class='button pro-add-to-cart' title='Added to cart' type='button'><span><i class='fa fa-shopping-cart' style='font-size: 16px;color:#F4A137;'></i> Added to Cart</span></a>")}),$(".add-to-cart-new-temp").click(function(){$.post("connection/tmp_cart.php",{tmp_cat_add:"data"},function(t){}),add_to_cart_new_temp($(this).attr("data-id-product")),$(this).replaceWith("<a class='button pro-add-to-cart' title='Added to cart' type='button'><span><i class='fa fa-shopping-cart' style='font-size: 16px;color:#F4A137;'></i> Added to Cart</span></a>")}),$(".add-to-acc").click(function(){add_to_acc($(this).attr("data-id-product")),$(this).replaceWith("<a class='button pro-add-to-cart' title='Added to cart' type='button'><span><i class='fa fa-shopping-cart' style='font-size: 16px;color:#F4A137;'></i> Added to Cart</span></a>")}),$(".add-to-acc-temp").click(function(){$.post("connection/tmp_cart.php",{tmp_cat_add:"data"},function(t){}),add_to_acc_temp($(this).attr("data-id-product")),$(this).replaceWith("<a class='button pro-add-to-cart' title='Added to cart' type='button'><span><i class='fa fa-shopping-cart' style='font-size: 16px;color:#F4A137;'></i> Added to Cart</span></a>")})}),$.post("connection/tmp_cart.php",{tmp_cat_add:"data"},function(t){});
  ...
  <script type="text/javascript">
    var Tawk_API=Tawk_API||{},Tawk_LoadStart=new Date;!function(){var e=document.createElement("script"),t=document.getElementsByTagName("script")[0];e.async=!0,e.src="https://embed.tawk.to/5d3ff1d7e5ae967ef80d6fde/default",e.charset="UTF-8",e.setAttribute("crossorigin","*"),t.parentNode.insertBefore(e,t)}();
  </script>
