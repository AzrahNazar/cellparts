							...
							<div class="single-product  white-bg col-md-3 col-sm-12" style="height:330px">
								<div class="product-img pt-20">
									...
									<?php	  if ($search['eq_code']!=''){
										echo "<a href=\"details-equility-products.php?key=4&id=".$search['eq_code']."\" style=\"color:#666666;\"> <img src=\"images/sumeda_p/".$search['imgpath']."\" style=\"height:167px;width:162px;\" id=\"myImg" .$i." \"alt=\"" .$search['book']."\"/> </a> "; 
									} else { ?>
										...
										<div class="product-content ">
											<div class="pro-title">
												<?php	  if ($search['eq_code']!=''){
													echo "<td colspan=2  width=\"96\" align=\"center\"><font color=\"#99FF00\" size=\"2\" face=\"Arial, Helvetica, sans-serif\"><a class=\"style2\" href=\"details-equility-products.php?key=4&id=".$search['eq_code']."\">Equality Items Available</a></font></td>  <h5><a href=\"details-equility-products.php?key=4&id=".$search['eq_code']."\" style=\"color:#666666;\">".$search['book']."</a></h5> "; 
												} else { ?> 
