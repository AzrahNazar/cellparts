...
if (isset($_SESSION['gest_user']) || isset($_SESSION['user'])) {
  ...
  if (isset($_GET['id'])) {
    ...
    $qty = 1;
    $rrr = "SELECT book, price, imgpath, sccode, deli_charges FROM books WHERE itemcode='$item'";
    $sql_itm = mysqli_fetch_assoc(mysqli_query($conn, $rrr));
    $sub_tot = $sql_itm['price']*$qty;
    $sccode = $sql_itm['sccode'];
    $deli_charges = $sql_itm['deli_charges'];
...
<head>
  ...
  #pre_loader {
    background: #f3f3f396 url(img/loading.gif) no-repeat center center;
    height: 100%;
    position: fixed;
    z-index: 9999999;
    right: 0;
                            ...
                            <tr>
                              ...
                              <?php if($wrapping == 1){?>
                                <tr>
                                  ...
                                  <td align="right"><h4 style="color:#fb530d;">LKR 100.00</h4></td>
                                  <input type="text" name="pkg" value="100.00" style="display: none;">
                                </tr>
                                <tr>
                                          ...
                                          <li>
                                            <div class="label-holder">
                                              <label class="radio b-label">Courier Service
                                                <input type="radio" name="del_method" value="1">
                                              </label>
                                  ...
                                  <table width="100%" cellpadding="8" class="table table1">
                                    ...
                                    <tr>
                                      ...
                                      <td><span id="txt_city"></span>
                                        <?php 
                                          if($wrapping==1){
                                              $g_tot = $sub_tot+100+$deli_charges;
                                          }else{
                                      ...
                                      <tr>
                                        <td colspan="3" align="right"><h5>Subtotal</h5>
                                          ...
                                          <td align="right"><h5>LKR <?php echo number_format($sub_tot, 2); ?></h5>
                                            <h5>LKR <span id="del_fee"><?php echo $deli_charges; ?></span></h5>
                                            <h5>LKR <span id="pro_fee">0.00</span></h5>
                                            <?php if($wrapping==1){
                                              $sub_tot+=100;?>
                                              <h5>LKR <span id="wrap_fee">100.00</span></h5><?php }else{?>
