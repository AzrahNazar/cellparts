...
$sqlw = "SELECT books.sccode, scat.wrapping, scat.w_price  FROM books Inner Join scat ON books.sccode = scat.sccode Inner Join live_cart ON books.itemcode = live_cart.Item_Code WHERE live_cart.User_ID =  '$user_id' AND scat.wrapping = '1' GROUP BY books.sccode";
$resultw = mysqli_query($conn, $sqlw);
$rowdeli = mysqli_fetch_array($resultw);
$countw = mysqli_num_rows($resultw);

$w_price = $rowdeli['w_price'];
...
$sqldel = "SELECT SUM(books.deli_charges) AS deli_charges FROM books Inner Join live_cart ON books.itemcode = live_cart.Item_Code WHERE live_cart.User_ID = '$user_id' AND books.deli_charges!= 250";
													...
													<td colspan="3" align="right">
														...
														<?php if($countw !=0){?>
															...
															<td align="right">
																...
																<h5>LKR <span id="del_fee"><?php echo number_format($deli_char, 2); ?></span></h5>
																<h5>LKR <span id="pro_fee">0.00</span></h5>
																<?php 
																	if($countw !=0){
																?>
																	<h5>LKR <span id="wrapping" data-value="<?php echo $wrap; ?>"><?php echo $wrap; ?></span></h5><br>
