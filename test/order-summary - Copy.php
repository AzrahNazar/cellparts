...
$sqldel = "SELECT SUM(books.deli_charges) AS deli_charges FROM books Inner Join live_cart ON books.itemcode = live_cart.Item_Code WHERE live_cart.User_ID = '$user_id' AND books.deli_charges!= 200";
