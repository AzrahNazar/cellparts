      ...
      <div class="container">
        <div class="row" style="">
          ...
          <div class="box" style="margin-top:40px;margin-bottom:150px;">
              ...
              <form class="form" method="post" id="login-form" action="connection/reset_request.php">
                <h3 style="text-align: center;">Reset your Password</h3>
                <h6 style="text-align: center;">An email will be sent to you with instructions on how to reset your password</h6> <br>  
        ...
        <div class="row"> 
          ...
          <div class="col-md-12" style="text-align: center;">
            <button type="submit" class="btn btn-primary" id="btn_reset" name="btn_reset">RECEIVE NEW PASSWORD BY EMAIL</button>
          </div>
          <?php
          if (isset($_GET['reset'])) {
            ...
            // echo"<script> alert('Please check your Email!!')</script> ";
              ...
              echo"<p class='badge badge-pill badge-success'>Please check your Email to reset password!</p> ";
              echo"</div>";
              echo"</div>";
            }
          }
