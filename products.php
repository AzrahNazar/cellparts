								...
								<div class="single-product  white-bg col-md-3 col-xs-6">
									...
									<div class="product-content ">
										<div class="pro-title">
											...
											<a class="hidden-xs" href="contact-us-sumedacellular-kurunegala-srilanka?inquiry=1&id=<?php echo $shrow['itemcode'];?>" class="button btn-primary" style="padding:5px;"><span><i class="fa fa-phone"></i> CONTACT US</span></a>
											<?php 
												}if(($qty == 0) && ($shrow['eq_code']!='')){
											    	$stk = "Switch to equal";
											    	$color  =  "white";
											...
											?>
											<h5 style=" color: <?php echo $color; ?>; margin-top: 10px;"><?php echo $stk; ?></h5>
											<a class="hidden-xs" href="details-equility-products.php?key=4&id=<?php echo $shrow['eq_code']; ?>" class="button btn-primary" style="padding:5px;"><span><i class="fa fa-reply"></i> SIMILAR PRODUCT</span></a>
											<?php 
												}else if($qty != 0){
													$stk = "Stock Available";
													$color  =  "green";
