...
//////////////////////new arrivals///////////////////////////	
    ...
    if (array_key_exists('add_to_cart_new_temp', $_POST)) {
		...
		if ($row == 0) {
			...
			$sql = "INSERT INTO live_cart VALUES (NULL ,'tmp_$user_id','$itm_id', '".$rows['book']."', '".$rows['imgpath']."' ,'1', '".$rows['price']."' , '$user_id"."_".$rowu['order_id']."', '1','".date("Y-m-d")."','$user_id','order pending','1')";
    ...
    if (array_key_exists('add_to_acc_temp', $_POST)) {
		...
		if ($row == 0) {
			...
			$sql = "INSERT INTO live_cart VALUES (NULL ,'tmp_$user_id','$itm_id', '".$rows['book']."', '".$rows['imgpath']."' ,'1', '".$rows['price']."' , '$user_id"."_".$rowu['order_id']."', 1,'".date("Y-m-d")."','$user_id','order pending','2')";
